...
$parcel$export(module.exports, "default", () => $3cf14265b4415c80$export$2e2bcd8739ae039);
function $c57d15194f31df6d$export$2e2bcd8739ae039(value, name) {
    if (isNaN(value) || value <= 0) throw new Error(`"${name}" must be a positive integer, but was ${value} (${typeof value})`);
}


const $bef404d85f2021d8$export$d971781c6009eb20 = 1e-10; // floating-point margin of error


function $a8ea980f6e03e527$export$2e2bcd8739ae039(x, a, b) {
    return Math.abs(a - x) < Math.abs(b - x) ? a : b;
}


function $52185cb5a34b64db$export$f653518feb1a7300(x, y, w, h, px, py) {
    return {
        x: (0, $a8ea980f6e03e527$export$2e2bcd8739ae039)(px, x, x + w),
        y: (0, $a8ea980f6e03e527$export$2e2bcd8739ae039)(py, y, y + h)
    };
}
function $52185cb5a34b64db$export$a3b9375a9680aa1a(x, y, w, h, x1, y1, x2, y2, ti1, ti2) {
...
function $52185cb5a34b64db$export$41d8adf939ed37ff(x1, y1, w1, h1, x2, y2, w2, h2) {
    return {
        x: x2 - x1 - w1,
        y: y2 - y1 - h1,
        w: w1 + w2,
...
function $52185cb5a34b64db$export$29c11b0e5eb0387a(x, y, w, h, px, py) {
    return px - x > (0, $bef404d85f2021d8$export$d971781c6009eb20) && py - y > (0, $bef404d85f2021d8$export$d971781c6009eb20) && x + w - px > (0, $bef404d85f2021d8$export$d971781c6009eb20) && y + h - py > (0, $bef404d85f2021d8$export$d971781c6009eb20);
}
function $52185cb5a34b64db$export$a298d70a4ea5c38c(x1, y1, w1, h1, x2, y2, w2, h2) {
    return x1 < x2 + w2 && x2 < x1 + w1 && y1 < y2 + h2 && y2 < y1 + h1;
}
function $52185cb5a34b64db$export$dc5a28bb7d6b43c(x1, y1, w1, h1, x2, y2, w2, h2) {
    const dx = x1 - x2 + (w1 - w2) / 2;
    const dy = y1 - y2 + (h1 - h2) / 2;
    return dx * dx + dy * dy;
}
function $52185cb5a34b64db$export$d5885a9399d7595f(x1, y1, w1, h1, x2, y2, w2, h2, goalX, goalY) {
    const _goalX = isNaN(goalX) ? x1 : goalX;
    const _goalY = isNaN(goalY) ? y1 : goalY;
    let dx = _goalX - x1;
    let dy = _goalY - y1;
    const { x: x , y: y , w: w , h: h  } = $52185cb5a34b64db$export$41d8adf939ed37ff(x1, y1, w1, h1, x2, y2, w2, h2);
    let overlaps;
    let nx, ny;
    let ti;
    // If the item was intersecting other
    if ($52185cb5a34b64db$export$29c11b0e5eb0387a(x, y, w, h, 0, 0)) {
        let { x: px , y: py  } = $52185cb5a34b64db$export$f653518feb1a7300(x, y, w, h, 0, 0);
        let wi = Math.min(w1, Math.abs(px)); // area of intersection
        let hi = Math.min(h1, Math.abs(py)); // area of intersection
        ti = -wi * hi; // `ti` is the negative area of intersection
        overlaps = true;
    } else {
        let [ti1, ti2, nx1, ny1] = $52185cb5a34b64db$export$a3b9375a9680aa1a(x, y, w, h, 0, 0, dx, dy, -Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
        ti1;
        // item tunnels into other
        if (!isNaN(ti1) && ti1 < 1 && Math.abs(ti1 - (ti2 || 0)) >= (0, $bef404d85f2021d8$export$d971781c6009eb20) && (0 < ti1 + (0, $bef404d85f2021d8$export$d971781c6009eb20) || 0 === ti1 && (ti2 || 0) > 0)) {
            ti = ti1;
            nx = nx1;
            ny = ny1;
            overlaps = false;
    ...
    if (overlaps) {
        if (dx === 0 && dy === 0) {
            ...
            // @ts-ignore
            let [ti1, _, _nx, _ny] = $52185cb5a34b64db$export$a3b9375a9680aa1a(x, y, w, h, 0, 0, dx, dy, -Number.MAX_SAFE_INTEGER, 1);
            nx = _nx;
            ny = _ny;
            if (!ti1) return;
            tx = x1 + dx * ti1;
...
function $9ad9d3458ab3a3b6$export$a28cf8d4b8e18f55(cellSize, cx, cy) {
    return [
        (cx - 1) * cellSize,
        (cy - 1) * cellSize
    ];
}
function $9ad9d3458ab3a3b6$export$8369d06a70f95b44(cellSize, x, y) {
    return [
        Math.floor(x / cellSize) + 1,
        Math.floor(y / cellSize) + 1
    ];
}
function $9ad9d3458ab3a3b6$export$dae871fd9623cca5(cellSize, ct, t1, t2) {
    const v = t2 - t1;
    if (v > 0) return [
        1,
        cellSize / v,
...
function $9ad9d3458ab3a3b6$export$c32d83d2523ad1a6(cellSize, x1, y1, x2, y2, traverseFunction) {
    const [cx1, cy1] = $9ad9d3458ab3a3b6$export$8369d06a70f95b44(cellSize, x1, y1);
    const [cx2, cy2] = $9ad9d3458ab3a3b6$export$8369d06a70f95b44(cellSize, x2, y2);
    let [stepX, dx, tx] = $9ad9d3458ab3a3b6$export$dae871fd9623cca5(cellSize, cx1, x1, x2);
    let [stepY, dy, ty] = $9ad9d3458ab3a3b6$export$dae871fd9623cca5(cellSize, cy1, y1, y2);
    let [cx, cy] = [
        cx1,
        cy1
    ];
...
function $9ad9d3458ab3a3b6$export$d14a64bab45dab8a(cellSize, x, y, w, h) {
    let [cx, cy] = $9ad9d3458ab3a3b6$export$8369d06a70f95b44(cellSize, x, y);
...
function $98119f38b047a9a2$export$2e2bcd8739ae039(desiredType, value, name) {
    if (typeof value !== desiredType) throw new Error(`"${name}" must be a ${desiredType}, but was a ${value} (${typeof value})`);
}


function $0ce28dc215ac7e12$export$2e2bcd8739ae039(x, y, w, h) {
    (0, $98119f38b047a9a2$export$2e2bcd8739ae039)("number", x, "x");
    (0, $98119f38b047a9a2$export$2e2bcd8739ae039)("number", y, "y");
    (0, $c57d15194f31df6d$export$2e2bcd8739ae039)(w, "w");
    (0, $c57d15194f31df6d$export$2e2bcd8739ae039)(h, "h");
}


function $ae0770fffad88459$export$d0b7ea69ab6056df(_world, column, _x, _y, _w, _h, _goalX, _goalY, _filter) {
    return {
        x: column.touch.x,
        y: column.touch.y,
        collisions: []
...
function $ae0770fffad88459$export$bb646b20bb93d339(world, column, x, y, w, h, goalX, goalY, filter) {
...
function $ae0770fffad88459$export$c1742949d0193489(world, column, x, y, w, h, goalX, goalY, filter) {
...
function $ae0770fffad88459$export$e3ce947fb98643bf(world, collision, x, y, w, h, goalX, goalY, filter) {
...
function $c5bc12a8beccdae3$export$2e2bcd8739ae039(a, b) {
    if (a.ti === b.ti) {
        const ir = a.itemRect;
        const ar = a.otherRect;
        const br = b.otherRect;
        const ad = (0, $52185cb5a34b64db$export$dc5a28bb7d6b43c)(ir.x, ir.y, ir.w, ir.h, ar.x, ar.y, ar.w, ar.h);
        const bd = (0, $52185cb5a34b64db$export$dc5a28bb7d6b43c)(ir.x, ir.y, ir.w, ir.h, br.x, br.y, br.w, br.h);
        return ad - bd;
    }
    return a.ti - b.ti;
}
...
function $5fd6d89ceeaca916$var$defaultFilter() {
    return "slide";
}
function $5fd6d89ceeaca916$var$sortByWeight(a, b) {
    return a.weight - b.weight;
}
function $5fd6d89ceeaca916$var$getCellsTouchedBySegment(self, x1, y1, x2, y2) {
    const cells = [];
    const visited = {};
    (0, $9ad9d3458ab3a3b6$export$c32d83d2523ad1a6)(self.cellSize, x1, y1, x2, y2, function(cx, cy) {
...
function $5fd6d89ceeaca916$var$getInfoAboutItemsTouchedBySegment(self, x1, y1, x2, y2, filter) {
    let cells = $5fd6d89ceeaca916$var$getCellsTouchedBySegment(self, x1, y1, x2, y2);
        ...
        if (cell?.items) {
            for (const itemID of Object.keys(cell.items))if (!visited[itemID]) {
                ...
                if (!filter || filter(itemID)) {
                    ...
                    w = rect.w;
                    h = rect.h;
                    const arr1 = (0, $52185cb5a34b64db$export$a3b9375a9680aa1a)(l, t, w, h, x1, y1, x2, y2, 0, 1);
                    ti1 = arr1[0];
                    ti2 = arr1[1];
                    if (!isNaN(ti1) && (0 < ti1 && ti1 < 1 || 0 < ti2 && ti2 < 1)) {
                        // -- the sorting is according to the t of an infinite line, not the segment
                        const [tii0, tii1] = (0, $52185cb5a34b64db$export$a3b9375a9680aa1a)(l, t, w, h, x1, y1, x2, y2, -Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
                        itemInfo.push({
                            item: itemID,
                            ti1: ti1,
                            ti2: ti2,
    ...
    return itemInfo.sort($5fd6d89ceeaca916$var$sortByWeight);
}
class $5fd6d89ceeaca916$export$812cd9544993280d {
    responses = {};
    cellSize = 0;
    currentIndex = 0;
    constructor(input){
    ...
    project(itemID, x, y, w, h, goalX, goalY, filter) {
        (0, $0ce28dc215ac7e12$export$2e2bcd8739ae039)(x, y, w, h);
        const _goalX = isNaN(goalX) ? x : goalX;
        const _goalY = isNaN(goalY) ? y : goalY;
        const _filter = filter || $5fd6d89ceeaca916$var$defaultFilter;
        let collisions = [];
        let visited = {};
        ...
        let tw = tr - tl;
        let th = tb - tt;
        let [cl, ct, cw, ch] = (0, $9ad9d3458ab3a3b6$export$d14a64bab45dab8a)(this.cellSize, tl, tt, tw, th);
        ...
        for (const other of Object.keys(dictItemsInCellRect))if (!visited[other]) {
            ...
            if (responseName && /* why do I have to do this extra check? */ this._hasItem(other)) {
                ...
                let collision = (0, $52185cb5a34b64db$export$d5885a9399d7595f)(x, y, w, h, otherRect.x, otherRect.y, otherRect.w, otherRect.h, _goalX, _goalY);
                if (collision) {
        ...
        return collisions.sort((0, $c5bc12a8beccdae3$export$2e2bcd8739ae039));
    }
    countCells() {
        let count = 0;
    ...
    // public
    toWorld(cx, cy) {
        return (0, $9ad9d3458ab3a3b6$export$a28cf8d4b8e18f55)(this.cellSize, cx, cy);
    }
    // public
    toCell(x, y) {
        return (0, $9ad9d3458ab3a3b6$export$8369d06a70f95b44)(this.cellSize, x, y);
    }
    // public
    queryRect(x, y, w, h, filter) {
        (0, $0ce28dc215ac7e12$export$2e2bcd8739ae039)(x, y, w, h);
        const [cl, ct, cw, ch] = (0, $9ad9d3458ab3a3b6$export$d14a64bab45dab8a)(this.cellSize, x, y, w, h);
        const dictItemsInCellRect = this.getDictItemsInCellRect(cl, ct, cw, ch);
        const items = [];
        for (const itemID of Object.keys(dictItemsInCellRect))if ((!filter || filter(itemID)) && (0, $52185cb5a34b64db$export$a298d70a4ea5c38c)(x, y, w, h, this.rects[itemID].x, this.rects[itemID].y, this.rects[itemID].w, this.rects[itemID].h)) items.push(itemID);
        return items;
    }
    // public
    queryPoint(x, y, filter) {
        ...
        const items = [];
        for (const itemID of Object.keys(dictItemsInCellRect))if ((!filter || filter(itemID)) && (0, $52185cb5a34b64db$export$29c11b0e5eb0387a)(this.rects[itemID].x, this.rects[itemID].y, this.rects[itemID].w, this.rects[itemID].h, x, y)) items.push(itemID);
        return items;
    }
    // public
    querySegment(x1, y1, x2, y2, filter) {
        const itemsInfo = $5fd6d89ceeaca916$var$getInfoAboutItemsTouchedBySegment(this, x1, y1, x2, y2, filter);
        const items = [];
    ...
    querySegmentWithCoords(x1, y1, x2, y2, filter) {
        let itemInfo = $5fd6d89ceeaca916$var$getInfoAboutItemsTouchedBySegment(this, x1, y1, x2, y2, filter);
        let dx = x2 - x1;
        let dy = y2 - y1;
        let info;
        let ti1;
    ...
    _remove(itemID) {
        ...
        let [cl, ct, cw, ch] = (0, $9ad9d3458ab3a3b6$export$d14a64bab45dab8a)(this.cellSize, itemRect.x, itemRect.y, itemRect.w, itemRect.h);
    ...
    update(itemID, x2, y2, w2, h2) {
        ...
        (0, $0ce28dc215ac7e12$export$2e2bcd8739ae039)(x2, y2, w2, h2);
        if (itemRect.x != x2 || itemRect.y != y2 || itemRect.w != w2 || itemRect.h != h2) {
            const [cl1, ct1, cw1, ch1] = (0, $9ad9d3458ab3a3b6$export$d14a64bab45dab8a)(this.cellSize, itemRect.x, itemRect.y, itemRect.w, itemRect.h);
            const [cl2, ct2, cw2, ch2] = (0, $9ad9d3458ab3a3b6$export$d14a64bab45dab8a)(this.cellSize, x2, y2, w2, h2);
    ...
    _check(itemID, goalX, goalY, filter) {
        let _goalX = goalX;
        let _goalY = goalY;
        const checkFilter = filter || $5fd6d89ceeaca916$var$defaultFilter;
        let visited = {};
        visited[itemID] = true;
...
const $5fd6d89ceeaca916$var$bump = {
    newWorld: function(cellSize) {
        cellSize = cellSize || 64;
        (0, $c57d15194f31df6d$export$2e2bcd8739ae039)(cellSize, "cellSize");
        const world = new $5fd6d89ceeaca916$export$812cd9544993280d({
            cellSize: cellSize,
            rects: {},
            rows: [],
            nonEmptyCells: {},
        ...
        world.addResponse("touch", (0, $ae0770fffad88459$export$d0b7ea69ab6056df));
        world.addResponse("cross", (0, $ae0770fffad88459$export$bb646b20bb93d339));
        world.addResponse("slide", (0, $ae0770fffad88459$export$c1742949d0193489));
        world.addResponse("bounce", (0, $ae0770fffad88459$export$e3ce947fb98643bf));
        return world;
    },
    rect: {
        getNearestCorner: (0, $52185cb5a34b64db$export$f653518feb1a7300),
        getSegmentIntersectionIndices: (0, $52185cb5a34b64db$export$a3b9375a9680aa1a),
        getDiff: (0, $52185cb5a34b64db$export$41d8adf939ed37ff),
        containsPoint: (0, $52185cb5a34b64db$export$29c11b0e5eb0387a),
        isIntersecting: (0, $52185cb5a34b64db$export$a298d70a4ea5c38c),
        getSquareDistance: (0, $52185cb5a34b64db$export$dc5a28bb7d6b43c),
        detectCollision: (0, $52185cb5a34b64db$export$d5885a9399d7595f)
    },
    responses: {
        touch: $ae0770fffad88459$export$d0b7ea69ab6056df,
        cross: $ae0770fffad88459$export$bb646b20bb93d339,
        slide: $ae0770fffad88459$export$c1742949d0193489,
        bounce: $ae0770fffad88459$export$e3ce947fb98643bf
    }
};
var $5fd6d89ceeaca916$export$2e2bcd8739ae039 = Object.freeze($5fd6d89ceeaca916$var$bump);
...
function $3cf14265b4415c80$var$invertCollision(c) {
    return {
        other: c.item,
        item: c.other,
        otherObj: c.itemObj,
...
function $3cf14265b4415c80$var$originPt(orig) {
    switch(orig){
        case "topleft":
            return vec2(-1, -1);
        case "top":
...
var $3cf14265b4415c80$export$2e2bcd8739ae039 = (k)=>{
    // only one global collision world now 
    const world = (0, $5fd6d89ceeaca916$export$2e2bcd8739ae039).newWorld(50);
    function barea() {
        ...
        return {
            ...
            load () {
                ...
                this.barea.w = w;
                this.barea.h = h;
                const orig = $3cf14265b4415c80$var$originPt(this.origin || "topleft");
            ...
            bmoveTo (dest) {
                ...
                for (const col of collisions){
                    ...
                    // @ts-ignore
                    col.otherObj.trigger("bumpcollide", this, $3cf14265b4415c80$var$invertCollision(col));
                }
            },
            bmove (...args) {
...
//# sourceMappingURL=bump-kaboom.cjs.map
